...
// drifted in practice: jsonic-cli shipped 0.4.1 and 0.4.2 while this very
// const sat at 0.4.0, because it lives under go/cmd/ rather than in a package
// root and the release orchestrator's file discovery missed it. It was
// invisible until someone read the file. A release that bumps package.json and
// forgets the constant now fails here instead of shipping a lie.
...
func TestVersionMatchesPackageJSON(t *testing.T) {
	// This test lives in go/cmd/jsonic, three levels below the repo root.
